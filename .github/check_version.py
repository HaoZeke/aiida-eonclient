...
Check version number in setup.json and aiida_eonclient/__init__.py and make sure
they match.
"""
...
import aiida_eonclient  # pylint: disable=wrong-import-position

VERSION = aiida_eonclient.__version__
