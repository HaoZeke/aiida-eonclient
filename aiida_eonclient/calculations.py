# -*- coding: utf-8 -*-
"""
Calculations provided by aiida_eonclient.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'eonclient'
        ...
        spec.output('eonclient', valid_type=SinglefileData, help='diff between file1 and file2.')
